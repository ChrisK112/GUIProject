            ...
            <div id="app">
                <div class={ style.container }>
                    ...
                    <form>
						...
						<input type = "radio" name ="tUnits" value = "C" class = {style.radio}> Centigrade </input>  <br> </br>
						<input type = "radio" name ="tUnits" value = "F" class = {style.radio}> Fahrenheit </input>  <br> </br>
                    </form>
                    </div>
                </div>
